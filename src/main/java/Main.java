...
public class Main {
    ...
    public static void main(String[] args) {
        Platform platform = new Platform(new DynamoProtocolFactory());
        ...
        List<String> registeredVirtualNodes = new ArrayList<String>(platform.getRegisteredVirtualNodes().keySet());
